...
export default function RotatingEarth({ width = 800, height = 600, className = "" }: RotatingEarthProps) {
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      context.fillStyle = "#00000000" // Set to transparent to work as background if needed
      context.fill()
      context.strokeStyle = "#2C2A26" // Changed to match theme charcoal
      ...
      if (landFeatures) {
        ...
        allDots.forEach((dot) => {
          ...
          if (
            ...
            context.fillStyle = "#86827A" // Stone grey dots
            context.fill()
          }
        })
      }
    ...
    const rotation = [0, 0]
    let autoRotate = true
    const rotationSpeed = 0.3 // Slower for subtle background
